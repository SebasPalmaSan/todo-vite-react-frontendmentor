...
const App = () => {
  ...
  return (
    <div className="bg-[url('./assets/images/bg-mobile-light.jpg')] transition-all duration-1000
    bg-contain bg-no-repeat bg-gray-300 dark:bg-gray-800 min-h-screen dark:bg-[url('./assets/images/bg-mobile-dark.jpg')]">
